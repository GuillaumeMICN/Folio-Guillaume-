    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#main">Article</a></li>
          <!--<li><a class="nav-link  scrollto" href="#comments">Commentaires</a></li>-->
        <!--   <li><a class="nav-link active  scrollto" href="#journal">Projets</a></li>-->
              ...
              <div class="container-main single-main">
                <div class="col-md-12">
                  <div class="block-main mb-30">
                    <img src="assets/img/RS3.jpg" class="img-responsive" alt="reviews2">
                    <div class="content-main single-post padDiv">
                      <div class="journal-txt">
                        <h4><a href="#">RAPPORT DE RECHERCHE SUR L'EMPRISE DES RESEAUX SOCIAUX</a></h4>
                      </div>
                      <div class="post-meta">
                        <ul class="list-unstyled mb-0">
                          <li class="author">par:<a href="#">Guillaume</a></li>
                          <li class="date">date:<a href="#">18 avril, 2022</a></li>
                          <li class="commont"><i class="ion-ios-heart-outline"></i><a href="#">3 Comments</a></li>
                        </ul>
                      </div>
                      <p class="mb-30">Lors de ma première année de master, j'ai eu la chance de coécrire une étude sur l'impact qu'avaient les réseaux sociaux sur mon quotidien. La méthode que nous avons employée est l'auto-ethnographie. Chaque étudiant a pu témoigner du rapport qu'il ou elle avait sur les réseaux sociaux.Ainsi, nous avions un journal de bord, ou nous recensions toutes nos heures passées sur chaque réseau social comme Facebook, Twitter, Instagram, Snapchat et Tik Tok.Ceci nous à permis de comprendre notre réelle utilisation de ces plateformes. Bonne lecture !    </p>
                      ...
                      <blockquote><a href="inutile.pdf" download>Visualiser le fichier(fichier indisponible pour le moment)</a></blockquote>
                  ...
                  <div class="cmt padDiv">
                    <form id="comment-form" method="post" action="" role="form">
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <input id="form_name" type="text" name="website" class="form-control" placeholder="site *">
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group">
