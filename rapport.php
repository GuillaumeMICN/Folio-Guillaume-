              ...
              <div class="container-main single-main">
                <div class="col-md-12">
                  <div class="block-main mb-30">
                    <img src="assets/img/rapmarketing.png" class="img-responsive" alt="reviews2">
                    <div class="content-main single-post padDiv">
                      <div class="journal-txt">
                        <h4><a href="#">RAPPORT SÉMANTIQUE SUR LE RAP FRANÇAIS</a></h4>
                      </div>
                      <div class="post-meta">
                      ...
                      <p class="mb-30">Lors de ma première année de master, nous avions à réaliser un rapport sémantique d'une trentaine de pages. L'étude devait exposer le discours qu'avait la presse française sur le sujet de notre choix. Etant un rap de français depuis mon enfance, j'ai saisi cette occasion et ainsi analyser les mots employés par les presses régionales et nationales pour les années 2013,2015 et 2018. Pourquoi ces dates ? Car celles-ci ont été un tournant dans le rap français au niveau du style de rap, du rythme, des flows. Bref, bonne lecture !  </p>
                      ...
                      <blockquote><a href="Discours-numérique1.pdf" download>Visualiser le fichier</a></blockquote>
